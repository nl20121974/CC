...
namespace CC.Areas.Admin
{
    ...
    public class GroupsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Code")] Group @group)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Code")] Group @group)
        {
            if (id != @group.Id)
            {
                return NotFound();
